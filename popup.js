...
const projects = ['tonic', 'multi-post stories', 'tonic2', 'mlti-poststories2']; /** name copied */
...
const allProjects = [
  {
    ...
    'featured image': {
      desktopImages: ['<img class="desktop" src="images/Snapshoot Portfolio - Copy.png" alt=""></img>', '<img class="desktop" src="images/desktop2.opng.png" alt=""></img>', '<img class="desktop" src="images/desktop3.png.png" alt=""></img>', '<img class="desktop" src="images/desktop4.png.png" alt=""></img>'],
      mobileImages: ['<img class="mobile" src="images/Snapshoot Portfolio (2).png" alt="">', '<img class="mobile" src="images/Snapshoot Portfolio (1).png" alt="">', '<img class="mobile" src="images/Snapshoot Portfolio.png" alt="">', '<img class="mobile" src="images/Snapshoot Portfolio (3).png" alt="">'],
    },
    technologies: '',
